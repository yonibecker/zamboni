...
const seasonLeagueLeaders = async (message) => {
  try {
  ...
  var embed = new Discord.MessageEmbed()
    .setColor(`#f2432c`)
    .setTitle(`${season} League Leaders`).setDescription(`
    **Skaters**
